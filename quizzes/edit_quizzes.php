            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    ...
                    ?>
                        ...
                        <input  id="id" type="text" name="lesson_id" class="form-control" value="<?php echo $lesson_id?>"><br>
                        
                        <label>Quiz order: </label>
                        <input type="text" name="quiz_order" class="form-control" value="<?php echo $quiz_order?>"><br>
                        
                        <label>Quiz Question: </label>
                        <input type="text" class="form-control" name="quiz_question" value="<?php echo $quiz_question?>"> <br>
                        
                        <label >Quiz image:</label>
                        <input type="file" name="quiz_image" class="form-control" accept="image/*" capture="user"><br>
                        
                        <label>Answer 1: *</label>
                        <input type="text" class="form-control" name="answer1" value="<?php echo $answer1?>"> <br>

                        <label>Answer 2: *</label>
                        <input type="text" class="form-control" name="answer2" value="<?php echo $answer2?>"> <br>

                        <label>Answer 3: *</label>
                        <input type="text" class="form-control" name="answer3" value="<?php echo $answer3?>"> <br>

                        <label>Answer 4: </label>
                        <input type="text" class="form-control" name="answer4" value="<?php echo $answer4?>"><br>

                        <label>Correct answer: </label>
                        <input type="text" class="form-control" name="correct_answer" value="<?php echo $correct_answer?>"> <br>

                        <label>Explanation: </label>
                        <textarea type="text" name="answer_explanation" rows="20" cols="30"class="form-control"><?php echo $quiz_id?>"</textarea><br>
